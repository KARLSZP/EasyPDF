from PyQt5.QtCore import (Qt, pyqtSignal, QUrl, QFileInfo, pyqtSlot)
...
class Viewer(QWidget):
    ...
    def buildWidget(self):
        self.viewArea = WebViewer()

    def loadFile(self, pdfPath):
        self.viewArea.loadPdf(pdfPath)
...
class FilesMerger(QWidget):
    ...
    def buildWidgets(self):
        ...
        self.noticeLabel = QLabel("<< Drag to set\n   file order")
